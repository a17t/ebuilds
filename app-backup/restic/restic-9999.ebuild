...
EGO_SUM=(
	...
	"github.com/Azure/azure-sdk-for-go v62.3.0+incompatible/go.mod"
	...
	"github.com/minio/minio-go/v7 v7.0.27/go.mod"
	...
	"github.com/pkg/xattr v0.4.6/go.mod"
...
if [[ ${PV} == "9999" ]] ; then
	EGIT_REPO_URI="https://github.com/restic/restic.git"
	inherit git-r3 
